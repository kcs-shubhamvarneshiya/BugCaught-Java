...
<body>
	...
	<!-- Navbar Start -->
	<div class="navbarlog">
		<p><i class="fa-solid fa-bug"></i>&nbsp; Bug<span>Caught</span></p>
	</div>
	<!-- Navbar End -->
	...
	<div class="mainForm">
		...
		<form action="/loginchk" method="post">
			 ...
			 <small id="FormValidation">${ErrMsg}</small> 

			<div class="form-group">
				<label>Email address</label> <input type="email"
					class="form-control" id="InputEmail" name="uemail"
					placeholder="Enter email" required="required"> <small
					id="emailValidation"></small>
			</div>

			<div class="form-group">
				<label>Password</label> <input type="password" class="form-control"
					id="InputPassword" name="upassword" placeholder="Enter Password"
					required="required"> <small id="passwordValidation"></small>
			</div>
