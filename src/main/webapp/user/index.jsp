					...
					<c:otherwise>
						<c:forEach var="team" items="${teamList}">
							<tr>
								...
								<td><a
									href="${pageContext.request.contextPath}/searchProject/${team.tid}"
									class="btnprimary"><i
							...
							<tr>
								...
								<c:choose>
									<c:when test="${(status=='Close')}">
										<td>
											<a class="btnsuccess"><i class="fa-solid fa-circle-check fa-beat-fade"></i></a>
										</td>
									</c:when>
									<c:otherwise>
										<td><a
											href="${pageContext.request.contextPath}/fixBug/${bug.bid}"
